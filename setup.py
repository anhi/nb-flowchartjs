...
setup_args = dict(
    ...
    description="nb-flowchartjs - Jupyter notebook extension for flowchart.js",
    long_description=README,
    author="Andreas Hildebrandt",
    author_email="andreas.hildebrandt@uni-mainz.de",
    url="http://github.com/anhi/nb-flowchartjs.git",
    license="MIT",
    platforms="Linux, Mac OS X, Windows",
    keywords=["jupyter", "ipython", "flowchart", "flowchart.js"],
    classifiers=[
